...
type BookServiceClient interface {
	...
	Delete(ctx context.Context, in *Book, opts ...grpc.CallOption) (*Book, error)
	Get(ctx context.Context, in *Book, opts ...grpc.CallOption) (*Book, error)
}
...
func (c *bookServiceClient) Update(ctx context.Context, in *Book, opts ...grpc.CallOption) (*Book, error) {
	out := new(Book)
	err := c.cc.Invoke(ctx, "/proto.BookService/Update", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *bookServiceClient) Delete(ctx context.Context, in *Book, opts ...grpc.CallOption) (*Book, error) {
	out := new(Book)
	err := c.cc.Invoke(ctx, "/proto.BookService/Delete", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *bookServiceClient) Get(ctx context.Context, in *Book, opts ...grpc.CallOption) (*Book, error) {
	out := new(Book)
	err := c.cc.Invoke(ctx, "/proto.BookService/Get", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type BookServiceServer interface {
	...
	Delete(context.Context, *Book) (*Book, error)
	Get(context.Context, *Book) (*Book, error)
...
func (UnimplementedBookServiceServer) Delete(context.Context, *Book) (*Book, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Delete not implemented")
}
func (UnimplementedBookServiceServer) Get(context.Context, *Book) (*Book, error) {
...
func _BookService_Get_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BookServiceServer).Get(ctx, req.(*Book))
	}
	return interceptor(ctx, in, info, handler)
}
